...
print("="*60, flush=True)
print("🚀 HỆ THỐNG SIGN2VI - FIX LỖI ĐA LUỒNG ĐỒ HỌA (XInitThreads) 🚀", flush=True)
print("="*60, flush=True)

# =========================================================================
# BƯỚC 1: ÉP OPENCV MỞ CỬA SỔ ĐỂ BẬT TÍNH NĂNG ĐA LUỒNG CHO LINUX
# Dòng này sẽ cứu toàn bộ hệ thống khỏi Segmentation fault!
# =========================================================================
print("⏳ [1/3] Khởi tạo luồng đồ họa X11 an toàn...", flush=True)
import cv2
cv2.namedWindow("SIGN2VI_CAMERA", cv2.WINDOW_NORMAL)
cv2.resizeWindow("SIGN2VI_CAMERA", 640, 480)
print("✅ Hệ thống X11 đã sẵn sàng đón MediaPipe!", flush=True)

# =========================================================================
# BƯỚC 2: BÂY GIỜ MỚI ĐƯỢC PHÉP GỌI MEDIAPIPE (Nó sẽ đi vào êm ru)
# =========================================================================
print("⏳ [2/3] Kích hoạt MediaPipe...", flush=True)
...
print("✅ MediaPipe đã sống sót qua ải EGL!", flush=True)

# =========================================================================
# BƯỚC 3: NẠP ONNX VÀ CHẠY
# =========================================================================
print("⏳ [3/3] Nạp mô hình AI...", flush=True)
...
def main():
    ...
    print("⏳ Khởi động Camera...", flush=True)
    ...
    print("\n💡 TẤT CẢ ĐÃ SẴN SÀNG! Đưa tay lên múa đi người anh em!", flush=True)
    ...
    try:
        while cap.isOpened():
            ...
            # ÉP HIỂN THỊ CỬA SỔ ĐỂ DUY TRÌ LUỒNG X11
            cv2.imshow("SIGN2VI_CAMERA", frame)
