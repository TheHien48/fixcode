...
# BẮT BUỘC IMPORT ONNXRUNTIME ĐẦU TIÊN
import onnxruntime as ort
import mediapipe as mp
import cv2
import numpy as np

# Ép OpenCV chạy 1 luồng và tắt GPU/OpenCL
...
def main():
    ...
    try:
        ...
        # THIẾT LẬP ÉP ONNX CHẠY 1 LUỒNG (CHỐNG TRÀN RAM & XUNG ĐỘT TRÊN JETSON)
    ...
    # Đã bỏ cv2.CAP_V4L2, trả về mặc định để tránh lỗi kẹt luồng
