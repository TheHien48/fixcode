import os
# --- BÙA CHÚ TỐI THƯỢNG (BẮT BUỘC PHẢI CÓ CHO JETSON NANO) ---
...
print("="*60, flush=True)
print("🚀 HỆ THỐNG SIGN2VI - BẢN THỂ HOÀN HẢO TỐI THƯỢNG 🚀", flush=True)
print("="*60, flush=True)

# =========================================================================
# 1. MEDIAPIPE LÊN TRƯỚC TIÊN (Chiếm trọn EGL và Protobuf nguyên vẹn)
# =========================================================================
print("⏳ [1/3] Kích hoạt MediaPipe...", flush=True)
...
# =========================================================================
# 2. OPENCV HÀNG CHÍNH HÃNG VÀO SAU (Đi ké đồ họa)
# =========================================================================
print("⏳ [2/3] Nạp OpenCV chuẩn Tegra...", flush=True)
if '/usr/lib/python3.6/dist-packages' not in sys.path:
    sys.path.insert(1, '/usr/lib/python3.6/dist-packages')
import cv2
cv2.ocl.setUseOpenCL(False)
cv2.setNumThreads(1)
print("✅ OpenCV sẵn sàng!", flush=True)

# =========================================================================
# 3. ONNX VÀ CÁC THƯ VIỆN KHÁC VÀO CUỐI CÙNG
# =========================================================================
...
print("✅ Toàn bộ thư viện đã nạp xong!", flush=True)
