...
# BẮT BUỘC MEDIAPIPE PHẢI NẰM Ở ĐÂY, TRƯỚC OPENCV!!! LỖI TẠI TAO!!!
...
def main():
    print("="*60, flush=True)
    print("🚀 HỆ THỐNG SIGN2VI - BẢN FIX CUỐI (BYPASS + ĐẢO IMPORT) 🚀", flush=True)
    print("="*60, flush=True)
    ...
    print("\n💡 HỆ THỐNG ĐÃ SẴN SÀNG! Ký hiệu CẢM ƠN theo chuẩn đồ án đi, kết quả in thẳng ra màn hình!", flush=True)
