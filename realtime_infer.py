import os
# Cấm đa luồng từ mức hệ thống
os.environ["OMP_NUM_THREADS"] = "1"
os.environ["OPENBLAS_NUM_THREADS"] = "1"

# ĐƯA MEDIAPIPE LÊN ĐẦU TIÊN ĐỂ NÓ LÀM VUA CÁI EGL
...
# Ép terminal dùng UTF-8 để in log tiếng Việt
...
def main():
    print("="*60)
    print("🚀 HỆ THỐNG SIGN2VI - CHẾ ĐỘ VƯỢT LỖI EGL TỐI THƯỢNG 🚀")
    print("="*60)
    ...
    print("✅ Chuẩn bị khởi tạo MediaPipe trước để đoạt EGL...")
    ...
    with mp_hands.Hands(
        ...
        print("✅ MediaPipe đã nuốt trọn EGL an toàn! Không sợ crash nữa.")
        print("🎥 Đang kết nối Camera USB...")
        
        # 2. KHỞI TẠO CAMERA BÊN TRONG NÀY, ĐI SAU MEDIAPIPE
        cap = cv2.VideoCapture(0, cv2.CAP_V4L2)
        if not cap.isOpened():
            print("❌ LỖI: Camera đang bị kẹt do lần sập trước!")
            print("👉 CÁCH SỬA: Hãy RÚT DÂY CAMERA RA, CẮM LẠI và chạy lại lệnh.")
            return

        cap.set(cv2.CAP_PROP_FRAME_WIDTH, 640)
        cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 480)
        print("💡 Hệ thống đang quét ngầm. Múa tay đi, kết quả sẽ in ra đây!")
