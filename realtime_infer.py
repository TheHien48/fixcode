...
def main():
    ...
    # 1. KHỞI TẠO CAMERA TRƯỚC (Giữ nguyên V4L2 cho Cam USB)
    ...
    # 3. KHỞI TẠO MEDIAPIPE (Lúc này EGL mới được gọi, sẽ không đụng độ nữa)
    with mp_hands.Hands(
