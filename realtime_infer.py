...
def main():
    ...
    with mp_hands.Hands(
        ...
        while cap.isOpened():
            ...
            # Khung đen làm nền chữ (Tăng cao lên 130px để chứa đủ 3 dòng)
            ...
            frame_rgb = put_vietnamese_text(frame_rgb, f"Dịch từng từ: {seq_str_vi}", (10, 45), font_size=24, color=(255, 255, 0))
