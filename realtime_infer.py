...
# =========================================================================
# CẤM THUẬT "BỊT MẮT": CHE GIẤU MÀN HÌNH DESKTOP KHỎI MEDIAPIPE
# Giúp MediaPipe không đâm đầu vào driver Tegra X11 gây Segfault
# =========================================================================
...
print("="*60, flush=True)
print("🚀 HỆ THỐNG SIGN2VI - CHẾ ĐỘ TÀNG HÌNH EGL (HEADLESS) 🚀", flush=True)
print("="*60, flush=True)

print("⏳ [1/3] Kích hoạt MediaPipe (Chế độ mù X11)...", flush=True)
...
print("✅ MediaPipe đã lách qua khe cửa EGL an toàn!", flush=True)

print("⏳ [2/3] Nạp AI và OpenCV Headless...", flush=True)
import cv2
...
def main():
    ...
    print("⏳ [3/3] Bật AI ONNX và Camera...", flush=True)
    try:
    ...
    print("\n💡 ÁNH SÁNG NƠI CUỐI ĐƯỜNG HẦM! Đưa tay lên múa đi, kết quả sẽ in thẳng ra đây!", flush=True)
