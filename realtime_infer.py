...
# =========================================================================
# 3. SAU ĐÓ MỚI GỌI MEDIAPIPE (Lúc này EGL đã được dọn cỗ sẵn, đi ké thôi)
# =========================================================================
...
print("="*60, flush=True)
print("🚀 HỆ THỐNG SIGN2VI - CHÂN LÝ CUỐI CÙNG (NATIVE OPENCV FIRST) 🚀", flush=True)
print("="*60, flush=True)

print("⏳ [1/3] Kích hoạt MediaPipe (Đi ké EGL)...", flush=True)
...
print("✅ MediaPipe an toàn, không bị giật điện nữa!", flush=True)

print("⏳ [2/3] Nạp ONNX và các thư viện khác...", flush=True)
...
print("✅ Nạp xong thư viện!", flush=True)
...
def main():
    ...
    print("⏳ [3/3] Khởi động AI và Camera...", flush=True)
    try:
    ...
    print("\n💡 ÁNH SÁNG NƠI CUỐI ĐƯỜNG HẦM! Đưa tay lên múa cái ký hiệu Cảm Ơn ngay đi!", flush=True)
...
if __name__ == "__main__":
    main()
    #OPENBLAS_CORETYPE=ARMV8 LD_PRELOAD=/usr/lib/aarch64-linux-gnu/libgomp.so.1 python -u src/realtime_infer.py