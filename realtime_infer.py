...
# 🌟 BƯỚC CHUỘC LỖI: TRẢ LẠI SỨC MẠNH CHO JETSON NANO 🌟
# Ép môi trường ảo nạp cái OpenCV đồ xịn của NVIDIA thay vì hàng dỏm
...
print("="*60, flush=True)
print("🚀 HỆ THỐNG SIGN2VI - BẢN FIX CUỐI CÙNG (DÙNG OPENCV NATIVE) 🚀", flush=True)
print("="*60, flush=True)
...
print("✅ MediaPipe an toàn, không còn đụng độ bộ nhớ!", flush=True)

print("⏳ [2/3] Nạp OpenCV chuẩn Tegra và ONNX...", flush=True)
import cv2
...
def main():
    ...
    print("\n💡 ĐỒ ÁN ĐÃ LÊN SÓNG! Quất cái ký hiệu Cảm Ơn vào đi người anh em!", flush=True)
